...
export default function V4() {
    ...
    React.useEffect(() => {
        // ===== SET INITIAL TITLE =====
        document.title = 'RSDKv4';
        
        // ===== EXPOSE EngineFS GLOBALLY FIRST =====
        (window as any).EngineFS = EngineFS;
        console.log('[v4] EngineFS exposed globally');

        // ===== INITIALIZE FAVICON LOADER =====
        FaviconLoader.init();
        console.log('[v4] FaviconLoader initialized');
    ...
    return (
        <>
            ...
            <div className='enginePage'>
                ...
                {engineReady && (
                    <>
                        <Script src='./lib/RSDKv4.js' strategy='afterInteractive' />
